...
#    Updated: 2017/04/05 17:42:07 by iwordes          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC    = check.c check_ps.c error.c init.c main.c show.c stk_cpy.c minmax.c
SRC   += $(addprefix sort/,merge.c sort1.c sort2.c)
